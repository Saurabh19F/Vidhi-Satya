...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[0.75rem] bg-surface-bright/60 p-6 shadow-ambient ring-1 ring-outline-variant/15 backdrop-blur-[20px]",
        className
      )}
      {...props}
    />
