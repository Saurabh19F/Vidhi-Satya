...
export function WhatsappFloat({ phone }: WhatsappFloatProps) {
  ...
  return (
    <div className="group fixed bottom-24 right-4 z-40 md:bottom-6 md:right-6">
      <span className="pointer-events-none absolute right-14 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-full bg-gradient-to-r from-primary to-primary-container px-3 py-1.5 text-xs font-semibold text-primary-foreground shadow-ambient opacity-0 translate-x-2 transition-all duration-200 group-hover:translate-x-0 group-hover:opacity-100">
        Talk to us
      </span>
      <a
